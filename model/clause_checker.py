...
## 중요한 검토 원칙:
1. **일반적이고 표준적인 조항은 문제로 지적하지 마세요**(100만원 이하 수선은 임차인 부담)
2. **당신의 법률 전문 지식**을 바탕으로 각 조항이 관련 법령에 위반되는지 판단해주세요
3. **절차적 정당성**과 **실체적 공정성**을 모두 고려해주세요
4. **계약 해지나 퇴거 관련 조항**에서는 적정한 절차와 기간이 보장되는지도 확인해주세요
5. **극단적인 표현**이 포함된 해지/퇴거 조항은 반드시 확인해주세요
6. **전세/월세 계약의 특성**에 맞는 법령 적용 여부를 확인해주세요
